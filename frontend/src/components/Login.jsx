...
export default function Login() {
  const { login, isAuthentication } = useContext(AuthContext)
  ...
  }, [isAuthentication, navigate, from])
  ...
  return (
    <main className='w-full min-h-screen flex items-center justify-center bg-[#121212]'>
      <div className=' p-10 rounded-2xl shadow-xl w-full max-w-md'>
        <h1 className='text-4xl font-bold text-center text-indigo-600 mb-8'>Log In</h1>
