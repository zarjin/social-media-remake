  ...
  return (
    <main className='w-full min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 py-10 px-4'>
      <div className='max-w-4xl mx-auto'>
        <h1 className='text-3xl font-bold text-gray-800 mb-8 text-center'>Community</h1>

        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          {userData.map((user) => (
            <div
              key={user._id}
              className='bg-white shadow-lg rounded-xl p-6 flex items-center space-x-6 hover:shadow-xl transition-shadow duration-300'
            >
              ...
              <div className='flex flex-col justify-center flex-1'>
                ...
                {user._id !== currentUserId && (
                  <button
                    ...
                    className={`px-5 py-2 ${isFollowing(user) ? 'bg-gray-600' : 'bg-blue-600'}
